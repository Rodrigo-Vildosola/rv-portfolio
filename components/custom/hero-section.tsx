    ...
    <Card className="mb-2 bg-white dark:bg-gray-900">
      <div className="flex flex-col h-full">
        ...
        <div className="flex h-48 md:h-64 rounded-md px-10 md:px-20 py-5 md:py-10 justify-center items-center relative ">
          <div className={cn("h-full w-full text-gray-900 dark:text-gray-100 bg-gradient-to-r flex-col overflow-hidden from-sky-500 to-blue-800 dark:from-blue-700 dark:to-gray-900 rounded-md flex justify-center items-center", font.className)}>
            <div className={cn(styles['move-left-to-right'], "text-xl whitespace-nowrap ")} style={{ animationDuration: `${getRandomSpeed()}s` }}>
              <span className="mx-6">Unit Testing</span>
              <span className="mx-6">RESTful API Development</span>
              <span className="mx-6">AWS</span>
              <span className="mx-6">Docker</span>
              <span className="mx-6">Git</span>
            </div>
            <div className={cn(styles['move-right-to-left'], "text-xl whitespace-nowrap ")} style={{ animationDuration: `${getRandomSpeed()}s` }}>
              ...
              <span className="mx-6">MySQL</span>
              <span className="mx-6">NumPy</span>
              <span className="mx-6">Pandas</span>
              <span className="mx-6">TensorFlow</span>
              <span className="mx-6">Keras</span>
            </div>
            <div className={cn(styles['move-left-to-right'], "text-xl whitespace-nowrap ")} style={{ animationDuration: `${getRandomSpeed()}s` }}>
              <span className="mx-6">React</span>
              <span className="mx-6">Next.js</span>
              <span className="mx-6">Django</span>
              <span className="mx-6">Flask</span>
              <span className="mx-6">Ruby on Rails</span>
              <span className="mx-6">Node.js</span>
            </div>
            <div className={cn(styles['move-right-to-left'], "text-xl whitespace-nowrap ")} style={{ animationDuration: `${getRandomSpeed()}s` }}>
              <span className="mx-6">Python</span>
              <span className="mx-6">JavaScript</span>
              <span className="mx-6">C</span>
              <span className="mx-6">C++</span>
              <span className="mx-6">C#</span>
              <span className="mx-6">SQL</span>
            </div>
          </div>
        </div>
